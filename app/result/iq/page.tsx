...
import { Printer, Home, User, Briefcase, Calendar, Brain, Share } from "lucide-react";
    ...
    <div className="min-h-screen bg-white text-black font-sans p-4 md:p-12 print:p-0">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-20 pt-10 border-t border-gray-100 text-center no-print flex flex-col md:flex-row items-center justify-center gap-4">
            {isAdmin ? (
                <Link href="/admin/dashboard" className="flex items-center gap-2 px-6 py-3 rounded-full font-bold text-sm text-gray-500 hover:text-black hover:bg-gray-100 transition mb-4 md:mb-0 md:mr-4">
                    ← Kembali ke Dashboard
                </Link>
            ) : (
                <p className="text-sm text-gray-400 italic">Dokumen rahasia. Diterbitkan secara otomatis oleh sistem.</p>
            )}
            
            <button onClick={() => setShareModalOpen(true)} className="w-full md:w-auto flex items-center justify-center gap-2 bg-gray-100 text-black px-8 py-4 rounded-full hover:bg-gray-200 transition font-bold text-sm">
