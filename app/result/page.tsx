    ...
    <div className="min-h-screen bg-white text-black font-sans p-4 md:p-12 print:p-0">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-10 text-center no-print pb-10">
            ...
            <button onClick={() => setShareModalOpen(true)} className="w-full md:w-auto bg-gray-100 text-black px-8 py-3 rounded-full hover:bg-gray-200 transition font-bold text-sm mr-4">
